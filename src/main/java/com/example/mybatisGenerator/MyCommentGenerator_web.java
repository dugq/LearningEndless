...
public class MyCommentGenerator_web implements CommentGenerator{
    ...
    public void addFieldComment(Field field, IntrospectedTable introspectedTable,
        ...
        if(Objects.equals(introspectedColumn.getJdbcTypeName(),"DATETIME")){
            ...
            sb.append("\" ,example = \"2018-04-16 1：11：11\")");
            ...
            sb.append("@ApiModelProperty(value = \"");
            sb.append(introspectedColumn.getRemarks());
            sb.append("\" ,example = \"2018-04-16\")");
            field.addJavaDocLine(sb.toString().replace("\n", " "));
        }else if ( Objects.equals(introspectedColumn.getJdbcTypeName(),"TIME")){
            field.addJavaDocLine("@JsonFormat(pattern=\"HH:mm:ss\",timezone = \"GMT+8\")");
            field.addJavaDocLine("@DateTimeFormat(pattern=\"HH:mm:ss\")");
            StringBuilder sb = new StringBuilder();
            sb.append("@ApiModelProperty(value = \"");
            sb.append(introspectedColumn.getRemarks());
            sb.append("\"  ,example = \"11：11：11\")");
            field.addJavaDocLine(sb.toString().replace("\n", " "));
        }
        if(Objects.equals(introspectedColumn.getJdbcTypeName(),"VARCHAR") || Objects.equals(introspectedColumn.getJdbcTypeName(),"CHAR")){
            field.addJavaDocLine("@Max(value = "+introspectedColumn.getLength()+",message=\""+introspectedColumn.getRemarks()+"最大长度为："+introspectedColumn.getLength()+"\")");
        }else{
